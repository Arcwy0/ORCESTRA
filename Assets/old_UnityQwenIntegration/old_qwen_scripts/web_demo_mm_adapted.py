...
import sys
sys.path.insert(0,r'/app/output_qwen_localization/')
from output_qwen_localization.tokenization_qwen import QWenTokenizer
...
def _get_args():
    ...
    parser.add_argument("-a", "--adapter-path", type=str, default=DEFAULT_ADAPT_CKPT_PATH,
                    help=" Adapter checkpoint name or path, default to %(default)r")
